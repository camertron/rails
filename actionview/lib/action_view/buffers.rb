...
module ActionView
  ...
  #   puts sbuf # => "hello\u0005"
  #
  # class OutputBuffer < BasicObject
  #   def initialize(*args)
  #     @buffer = OutputBufferStack.new(*args)
  #   end

  #   def method_missing(method_name, *args, **kwargs, &block)
  #     was_safe = @buffer.buffer_stack.all?(&:html_safe?)
  #     result = @buffer.send(method_name, *args, **kwargs, &block)
  #     if !@buffer.buffer_stack.all?(&:html_safe?) && was_safe
  #       $stdout.puts "NOT HTML SAFE AFTER CALLING #{method_name}"
  #     end
  #     result
  #   end

  #   def respond_to_missing?(method_name)
  #     @buffer.respond_to?(method_name)
  #   end
  # end
